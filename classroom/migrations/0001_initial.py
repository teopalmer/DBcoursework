    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interests', models.ManyToManyField(related_name='interested_citizens', to='classroom.Subject')),
            ],
        ),
        migrations.AddField(
            model_name='quiz',
        ...
        migrations.AddField(
            ...
            name='citizen',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='taken_quizzes', to='classroom.citizen'),
        ),
        migrations.AddField(
            model_name='citizenanswer',
            name='citizen',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_answers', to='classroom.citizen'),
        ),
        migrations.AddField(
            model_name='citizen',
            name='quizzes',
